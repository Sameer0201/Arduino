//http://ch00ftech.com/wp-content/uploads/2012/10/main2.c
  ...
  for (i = 0; i < 21; i++)
  {
    ...
    for (j = 0; j < 21; j++)
    {
      ...
      if ((previousQR[i] & mbit) != c * mbit)
      {
        ...
        Tft.fillRect(j * s + xo, i * s + yo, s - 1, s - 1, color);
      }
...
int generate() {
  ...
  */
  ...
  unsigned char tempoutputmatrix[56] = {128, 63, 192, 247, 247, 137, 254, 34, 209, 95, 36, 250, 139, 124, 127, 31, 160, 10, 248, 255, 255, 191, 255, 255, 255, 255, 255, 254, 255, 255, 255, 255, 251, 255, 255, 253, 63, 224, 255, 247, 253, 255, 162, 255, 95, 244, 255, 139, 254, 127, 223, 255, 15, 248, 255, 255};

  //@arduinoenigma
  for (k = 0; k < 56; k++)
  {
    outputmatrix[k] = tempoutputmatrix[k];
  }
